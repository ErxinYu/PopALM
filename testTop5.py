...
with open("/home/xxx/data/ppo_weibo/weiboGen/test.json") as f_label, \
   open("/home/xxx/output/ptuningGen/Top5/generated_predictions.txt") as f_pred_ori, \
   open("/home/xxx/output/PPOGen_epoch2_gen1_return1/Top5/generated_predictions.txt") as f_pred_FT, \
   open("/home/xxx/output/PPOGen_ours_epoch2_gen5_return1/PPOTop5/generated_predictions.txt") as f_pred_PPO, \
   open("/home/xxx/output/compare_gen_label_top5.txt","w+") as f_compare:
    ...
    for i in range(1000):
        ...
        predOri_1 = json.loads(predOri_lines[5*i])["predict"]
        predOri_2 = json.loads(predOri_lines[5*i+1])["predict"]
        predOri_3 = json.loads(predOri_lines[5*i+2])["predict"]
        predOri_4 = json.loads(predOri_lines[5*i+3])["predict"]
        predOri_5 = json.loads(predOri_lines[5*i+4])["predict"]
        predFT_1 = json.loads(predFT_lines[5*i])["predict"]
        predFT_2 = json.loads(predFT_lines[5*i+1])["predict"]
        predFT_3 = json.loads(predFT_lines[5*i+2])["predict"]
        predFT_4 = json.loads(predFT_lines[5*i+3])["predict"]
        predFT_5 = json.loads(predFT_lines[5*i+4])["predict"]
        predPPO_1 = json.loads(predPPO_lines[5*i])["predict"]
        predPPO_2 = json.loads(predPPO_lines[5*i+1])["predict"]
        predPPO_3 = json.loads(predPPO_lines[5*i+2])["predict"]
        predPPO_4 = json.loads(predPPO_lines[5*i+3])["predict"]
        predPPO_5 = json.loads(predPPO_lines[5*i+4])["predict"]

        all_predOri.append(predOri_1)
        all_predOri.append(predOri_2)
        all_predOri.append(predOri_3)
        all_predOri.append(predOri_4)
        all_predOri.append(predOri_5)
        m_Distict_predOri = [predOri_1,predOri_2,predOri_3,predOri_4,predOri_5]
        ...
        all_predFT.append(predFT_4)
        all_predFT.append(predFT_5)
        m_Distict_predFT = [predFT_1,predFT_2,predFT_3,predFT_4,predFT_5]
        ...
        all_predPPO.append(predPPO_4)
        all_predPPO.append(predPPO_5)
        m_Distict_predPPO = [predPPO_1,predPPO_2,predPPO_3,predPPO_4,predPPO_5]
        ...
        print("predOri_1:",predOri_1,file=f_compare)
        print("predOri_2:",predOri_2,file=f_compare)
        print("predOri_3:",predOri_3,file=f_compare)
        print("predOri_4:",predOri_4,file=f_compare)
        print("predOri_5:",predOri_5,file=f_compare)
        print("predFT_1: ",predFT_1,file=f_compare)
        print("predFT_2:", predFT_2,file=f_compare)
        print("predFT_3:", predFT_3,file=f_compare)
        print("predFT_4:", predFT_4,file=f_compare)
        print("predFT_5:", predFT_5,file=f_compare)
        print("predPPO_1:",predPPO_1,file=f_compare)
        print("predPPO_2:",predPPO_2,file=f_compare)
        print("predPPO_3:",predPPO_3,file=f_compare)
        print("predPPO_4:",predPPO_4,file=f_compare)
        print("predPPO_5:",predPPO_5,file=f_compare)
