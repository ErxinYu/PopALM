...
from trl import AutoModelForCausalLMWithValueHead, PPOConfig, PPOTrainer, set_seed, create_reference_model, PPOTrainer_new
...
ppo_trainer = PPOTrainer_new(config, model, ref_model, tokenizer, dataset=datasets, data_collator=data_collator)
