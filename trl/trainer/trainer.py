...
class Trainer:
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        if self.label_smoother is not None and "labels" in inputs:
            ...
            labels = None
        # print("**inputs",inputs,inputs["input_ids"].size())
        ...
        # print("labels",labels, labels.size(),labels.dtype)
    ...
    def evaluate(
        ...
        start_time = time.time()
        eval_loop = self.prediction_loop if self.args.use_legacy_prediction_loop else self.evaluation_loop #eval_loop
        output = eval_loop(
            eval_dataloader,
    ...
    def predict(
        ...
        eval_loop = self.prediction_loop if self.args.use_legacy_prediction_loop else self.evaluation_loop #self.args.use_legacy_prediction_loop=Flase
        output = eval_loop(
    ...
    def evaluation_loop(
        ...
        for step, inputs in enumerate(dataloader):
            ...
            #print("inputs from trainer evaluation_loop:",inputs)
            ...
            if args.eval_accumulation_steps is not None and (step + 1) % args.eval_accumulation_steps == 0:#args.eval_accumulation_steps=None 不进入
